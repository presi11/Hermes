...
const Orders = () => {
  ...
  const {
    ...
    variables: { orderRestaurantName: userMetadata.restaurant, orderStatus: ["CONFIRMADO", "EN_PREPARACION", "PREPARADO"] },
  });
  ...
  const {
    ...
    variables: {
      orderRestaurantName: userMetadata.restaurant, orderStatus:["ENTREGADO", "ANULADO"]
